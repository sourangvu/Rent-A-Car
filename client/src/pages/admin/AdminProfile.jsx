...
export const AdminProfile = () => {
  ...
  const [profileData, isLoading] = useFetch(`/admin/profile`);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await axiosInstance.put("/admin/profile-update", formData, {
        headers: {
        ...
        <div className="card-body items-center text-center p-6 w-full">
          {editMode ? (
            ...
            <>
              ...
              <h2 className="text-black mb-1">{profileData?.email}</h2>
              <h2 className="text-gray-600">{profileData?.mobile}</h2>
